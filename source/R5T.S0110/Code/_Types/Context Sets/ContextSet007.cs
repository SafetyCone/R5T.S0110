...
{
    /// <summary>
    /// A good item group element context set.
    /// </summary>
    [ContextSetMarker]
    public class ContextSet007 : IContextSetMarker,
        ...
        IWithContext<Context007>
    {
        ...
        Context007 IWithContext<Context007>.Context { get; set; }
        Context007 IHasContext<Context007>.Context => (this as IWithContext<Context007>).Context;
    }
}
